...
type AssembleBlockRequest struct {
	...
	NoTxPool       bool     `protobuf:"varint,102,opt,name=no_tx_pool,json=noTxPool,proto3" json:"no_tx_pool,omitempty"`
	GasLimit       *uint64  `protobuf:"varint,103,opt,name=gas_limit,json=gasLimit,proto3,oneof" json:"gas_limit,omitempty"`
	Eip_1559Params []byte   `protobuf:"bytes,104,opt,name=eip_1559_params,json=eip1559Params,proto3,oneof" json:"eip_1559_params,omitempty"`
}
...
type AssembledBlockData struct {
	...
	// Optimism adds this field, , offset starting at 101 to avoid future conflicts
	ParentBeaconBlockRoot *types.H256 `protobuf:"bytes,101,opt,name=parent_beacon_block_root,json=parentBeaconBlockRoot,proto3,oneof" json:"parent_beacon_block_root,omitempty"`
}
...
var file_execution_execution_proto_rawDesc = []byte{
	...
	0x0a, 0x0c, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x65,
	...
	0x18, 0x66, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x6e, 0x6f, 0x54, 0x78, 0x50, 0x6f, 0x6f, 0x6c,
	0x12, 0x20, 0x0a, 0x09, 0x67, 0x61, 0x73, 0x5f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x18, 0x67, 0x20,
	...
	0x61, 0x72, 0x61, 0x6d, 0x73, 0x18, 0x68, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x02, 0x52, 0x0d, 0x65,
	...
	0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x72, 0x6f, 0x6f, 0x74, 0x18, 0x65, 0x20, 0x01, 0x28, 0x0b,
